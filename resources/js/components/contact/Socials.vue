    ...
    <section class="socials-v3 py-8 lg:py-12">
        <div class="mx-auto w-[calc(100%_-_2.5rem)] max-w-7xl lg:w-[calc(100%_-_4rem)]">
            ...
            <ul class="socials-v3__btns">
                <li>
                    <a :href="socials.twitter" class="socials-v3__btn">
                        <svg class="icon inline-block h-[1em] w-[1em] shrink-0 fill-current leading-none text-inherit" viewBox="0 0 32 32">
                ...
                <li>
                    <a :href="socials.facebook" class="socials-v3__btn">
                        <svg class="icon inline-block h-[1em] w-[1em] shrink-0 fill-current leading-none text-inherit" viewBox="0 0 32 32">
                ...
                <li>
                    <a :href="socials.youtube" class="socials-v3__btn">
                        <svg class="icon inline-block h-[1em] w-[1em] shrink-0 fill-current leading-none text-inherit" viewBox="0 0 32 32">
                ...
                <li>
                    <a :href="socials.instagram" class="socials-v3__btn">
                        <svg class="icon inline-block h-[1em] w-[1em] shrink-0 fill-current leading-none text-inherit" viewBox="0 0 32 32">
