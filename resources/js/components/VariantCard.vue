<template>
    ...
    >
        ...
        <p class="mx-0 mt-3 mb-4 flex items-center gap-3 text-left text-[0.9375rem] leading-[1.58] text-zinc-700">
            Precio: <span class="font-bold" :class="{ 'has-discount': variant.has_discounts }">{{ variant.price_in_dollars }} </span>
            <span v-if="variant.has_discounts">{{ variant.discounted_price_in_dollars }}</span>
        </p>
